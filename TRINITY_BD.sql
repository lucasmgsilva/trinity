...
AS
	BEGIN TRY
		BEGIN TRAN 
			...
			-- 0 Atualização pro Cliente Pessoa Física
			-- 1 Atualização pro Cliente Pessoa Jurídica
			IF(@type = 0)
			BEGIN
				UPDATE CLIENTEPF
